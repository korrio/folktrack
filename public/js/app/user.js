...
$(window).on("coinbaseReady", function ()
{
    getUser(globUserContract, function(data){      
      ...
      $("#userImage").attr('src','https://nouns.wtf/static/media/noggles.7644bfd0.svg'+data.profileHash);
...
$("#editUser").on('click',function(){
  ...
  getUser(globUserContract, function(data){
       ...
       var profileImageLink = 'https://nouns.wtf/static/media/noggles.7644bfd0.svg'+data.profileHash;
